...
entry:
  ...
  %3 = getelementptr inbounds [4 x i8]* @.str, i32 0, i32 0, !generated_instruction !0
  %call = call i32 @foo(i32* %c, i32 %2, i8* %3)
  store i32 %call, i32* %x, align 4
  %4 = load i32* %x, align 4
  %5 = getelementptr inbounds [4 x i8]* @.str1, i32 0, i32 0, !generated_instruction !0
  %call1 = call i32 (i8*, ...)* @printf(i8* %5, i32 %4)
  %6 = bitcast [3 x i32]* %buf to i8*
  %7 = bitcast [3 x i32]* @main.buf to i8*, !generated_instruction !0
...
if.end:                                           ; preds = %if.then, %entry
  %9 = bitcast [2 x [2 x [3 x i8]]]* %s to i8*
  %10 = getelementptr inbounds [2 x [2 x [3 x i8]]]* @main.s, i32 0, i32 0, !generated_instruction !0
  %11 = getelementptr inbounds [2 x [3 x i8]]* %10, i32 0, i32 0, !generated_instruction !0
  %12 = getelementptr inbounds [3 x i8]* %11, i32 0, i32 0, !generated_instruction !0
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %9, i8* %12, i32 12, i32 1, i1 false)
...
!0 = metadata !{metadata !"constantExpr"}
