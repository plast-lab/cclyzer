...
class Analysis(object):
    ...
    def compute_stats(self):
        self._stats = (
            ...
            .count('callgraph|static_callgraph:edge', title='static call-graph edges')
            .count('callgraph|static_callgraph:fn_edge', title='static call-graph edges (FxF)')
            .count('points_to|callgraph:edge', title='call-graph edges')
            .count('points_to|stripctx_callgraph:edge', title='call-graph edges (no ctx)')
