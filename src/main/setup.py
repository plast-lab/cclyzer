"""The setup script. It is not being used yet."""
...
def read(fname):
    ...
    It's nice, because now 1) we have a top level README file and 2)
    it's easier to type in the README file than to put a raw string in
    below ...
