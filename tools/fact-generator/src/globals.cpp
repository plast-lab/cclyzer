...
void
FactGenerator::visitGlobalAlias(const llvm::GlobalAlias *ga, const refmode_t &refmode)
{
    //------------------------------------------------------------------
...
void
FactGenerator::visitGlobalVar(const llvm::GlobalVariable *gv, const refmode_t &refmode)
{
